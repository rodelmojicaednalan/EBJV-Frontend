  ...
  useEffect(() => {
    ...
    const fetchUserDetails = async () => {
      try {
        ...
        const { username, email, first_name, last_name, sex, roles } =
          response.data;
        const role =
          roles.length > 0 ? roles[0].role_name : 'No Role';
      ...
      <div className="col-lg-12">
        <div className="row custom-row">
          ...
          >
            ...
            <p>
              This is your profile page, where you can customize your
              profile and change your password as needed
            </p>
          </div>
