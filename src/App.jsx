...
function Layout() {
  ...
  const shouldHideSidebar = () => {
    ...
    const isResetPassword = /^\/reset-password\/[a-zA-Z0-9]+$/.test(
      location.pathname
    );
      ...
      <AuthContextProvider>
        <>
          ...
          <Routes>
            ...
            />
            <Route
              path="/wait-instructions"
              element={<WaitInstructions />}
            />
            <Route
              path="/userlist"
              element={
            ...
            <Route
              path="/ifc-viewer/:projectId/:fileName"
              element={<IfcViewer />}
            />
            ...
            />
            <Route
              path="/project-folder/pdf-from-model/:projectId"
              element={
                <ProtectedRoute
                  element={<PDFFromIFCViewer />}
                  allowedRoles={['Superadmin', 'Admin', 'Client']}
                />
              }
            />
            ...
            <Route
              path="/project-folder/:projectId/data/project-explorer"
              element={
                <ProtectedRoute
            ...
            />
            <Route
              path="/project-folder/:projectId/data/project-explorer/subfolder/:folderName"
              element={
                <ProtectedRoute
                  element={<SubFolders />}
                  allowedRoles={['Superadmin', 'Admin', 'Client']}
            ...
            <Route
              path="/project-folder/:projectId/project-activity"
              element={
                <ProtectedRoute
        ...
        <Route path="/project-folder/:projectId/project-ToDos" element={<ProtectedRoute element={<ProjectToDo />} allowedRoles={['Admin', 'Client']} />} /> */}
            <Route
              path="/project-folder/:projectId/project-contributors"
              element={
                <ProtectedRoute
            ...
            />
            <Route
              path="/project-folder/:projectId/settings/edit-project"
              element={
                <ProtectedRoute
